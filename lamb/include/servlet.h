...
public:
    ...
    virtual int32_t handle(lamb::http::HttpRequest::ptr request
                   ...
                   , lamb::http::HttpSession::ptr session) = 0;
...
public:
    ...
    /// 函数回调类型定义
    typedef std::function<int32_t (lamb::http::HttpRequest::ptr request
                   , lamb::http::HttpResponse::ptr response
                   , lamb::http::HttpSession::ptr session)> callback;
    ...
    virtual int32_t handle(lamb::http::HttpRequest::ptr request
                   , lamb::http::HttpResponse::ptr response
                   , lamb::http::HttpSession::ptr session) override;
private:
    /// 回调函数
    callback m_cb;
};
