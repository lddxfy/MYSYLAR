#ifndef __lamb_ADDRESS_H__
#define __lamb_ADDRESS_H__
#include <memory>
#include <sys/types.h>
#include <iostream>
...
#define lamb_LITTLE_ENDIAN 1
#define lamb_BIG_ENDIAN 2
...
#define lamb_BYTE_ORDER lamb_BIG_ENDIAN
#else
#define lamb_BYTE_ORDER lamb_LITTLE_ENDIAN
#endif

#if lamb_BYTE_ORDER == lamb_BIG_ENDIAN
...
public:
    ...
    */
     ...
     * @param[in] host 域名,服务器名等.举例: www.lamb.top[:80] (方括号为可选内容)
...
public:
     ...
     * @param[in] address 域名,IP,服务器名等.举例: www.lamb.top
     * @param[in] port 端口号
